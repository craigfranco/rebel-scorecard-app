      ...
      {!selectedProperty ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl border border-border p-6 shadow-sm flex flex-col items-center justify-center gap-4">
            ...
            {scorecard && <ScoreGauge score={scorecard.total.total} pass={scorecard.total.pass} maxPossible={scorecard.total.maxPossible} gssIncomplete={scorecard.total.gssIncomplete} />}
          ...
          <div className="lg:col-span-3 bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                {scorecard && (() => {
                  const nonGssIncomplete = kpiRows.filter(r => r.measure !== `GSS — ${scorecard.gssStd.label}`).some(r => r.incomplete);
                    ...
                    <tfoot>
                      <tr style={{ backgroundColor: '#2d4b5e' }}>
                        <td colSpan={5} className="py-3 px-4 font-bold text-white text-sm">
                          Total Score
                          {gssIncomplete && <span className="ml-2 text-white/60 text-xs font-normal">(GSS N/A — max {maxPossible} pts)</span>}
                        </td>
