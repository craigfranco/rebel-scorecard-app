...
export function generateScorecardPDF(property, entry, periodType, selectedMonth, selectedYear) {
  ...
  // Logo image
  doc.addImage(REBEL_LOGO_BASE64, 'PNG', 28, 14, 80, 40, undefined, 'FAST');
