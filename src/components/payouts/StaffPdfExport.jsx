  ...
  const handleDownload = () => {
    ...
    try {
      ...
      const bonusRows = bonus ? [
        { comp: 'GOP Bonus', gate: bonus.gopGatePassed ? 'Passed' : 'Failed', amt: fmt(bonus.gop) },
        { comp: 'GOP Margin Bonus', gate: bonus.gopGatePassed ? 'Passed' : 'Failed', amt: fmt(bonus.gopMargin) },
