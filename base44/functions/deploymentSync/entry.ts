  ...
  try {
    ...
    for (const rec of incomingProperties) {
      ...
      const payload = {
        ...
        gm_name: rec.gm_name || rec.property_gm || rec.general_manager || null,
        lead_type: rec.lead_type || null,
        department: rec.department || null,
        rooms: rec.rooms != null ? Number(rec.rooms) : null,
        address: rec.address || null,
        website: rec.website || null,
        corporate_operations: rec.corporate_operations || null,
        corporate_finance: rec.corporate_finance || null,
        corporate_hr: rec.corporate_hr || null,
        corporate_revenue: rec.corporate_revenue || null,
        corporate_sales: rec.corporate_sales || null,
        corporate_ecommerce: rec.corporate_ecommerce || null,
        property_gm: rec.property_gm || rec.gm_name || null,
        property_dof: rec.property_dof || null,
        property_hrd: rec.property_hrd || null,
        property_dorm: rec.property_dorm || null,
        property_dosm: rec.property_dosm || null,
        property_doe: rec.property_doe || null,
        is_active: true,
      };
